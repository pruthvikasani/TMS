      ...
      <div class="navbar navbar-dark bg-dark box-shadow">
        <div class="container d-flex justify-content-between">
		  ...
		  <div class="pull-right">
			     ...
			     <a href="console.php" style="text-decoration:none;color:white;"><button name="edit" style="background:white;" class="btn btn-default my-2 active">Home</button></a>
                <a href="pushpull_data.php" style="text-decoration:none;color:white;"><button name="edit" class="btn btn-warning my-2">Push to Pull</button></a>
                <a href="voiceoftech_data.php" style="text-decoration:none;color:white;"><button class="btn btn btn-primary my-2">Voice of Tech</button></a>
		 ...
		 $query = "SELECT * FROM `user_requests`;";
			if(count(fetchAll($query)) > 0)
			{
				...
				echo "<tr>
					...
					{
					$search = "link";
					$final = str_replace($search,'',$result);
					echo "<td><a href='$final' target='_new'>View Profile</a></td>";
					
					}
					else
					{
					echo "<td><a href='upload/".$row['profile']."' target='_new'>View Profile</a></td>";
					...
					<td style='white-space: nowrap'>
								<a href="accept.php?id=<?php echo $row['id']; ?>" class="btn btn-success my-1">Accept</a>
								<a href="reject.php?id=<?php echo $row['id']; ?>" class="btn btn-danger my-1">Reject</a>
