      ...
      <div class="navbar navbar-dark bg-dark box-shadow">
        <div class="container d-flex justify-content-between">
		  ...
		  <div class="pull-right">
                ...
                <a href="voiceoftech_data.php" style="text-decoration:none;color:white;"><button name="edit" class="btn btn btn-primary my-2 active">Voice of Tech</button></a>
		 ...
		 $query = "SELECT * FROM `voiceoftech`;";
			if(count(fetchAll($query)) > 0)
			{
				...
				echo "<tr>
					...
					<td>".$row['invention']."</td>
                    <td>".$row['public']."</td>
					<td><a href='".$row['location']."' target='_new'>View</a></td>
					<td>".$row['timestamp']."</td>
				  </tr>" ?>
