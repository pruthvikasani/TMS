...
<body>
    ...
    <nav id="nav">
      <ul>
        ...
        <li><a href="objective.php" style="color:grey;">Objective</a></li>
  ...
  <div class="container">
	...
	<div class="col-md-12">
        ...
        <br>         
        <p style="text-align: justify;">Taking stock of existing collaborative initiatives to drive open innovations and identify synergies and opportunities for enhanced cooperation with materials scientist and metallurgist across the nation to reinvent technology in accordance to industry needs.</p> <br>
        <p style="text-align: justify;">Reasonable number of experts, scientists and researchers are available across India. Strengthening interactions between industry and research institutions like universities, colleges and research institutes have over the last years increasingly been seen as a strategic instrument for regional and national innovation, economic growth and competitiveness </p> <br>
        
        <p><strong>HIGHLIGHTED ISSUES</strong> <br>
            The plenary at this year’s materials and metallurgy forum will cover three key questions that companies typically face as they address the efficiency challenge: 
            <ul style="text-align: left; margin-left: 15px;">
                <li>Identifying the right expert to engage and work with</li>
                <li>Resources and its capabilities aren’t known widely to who seeks such solution providers</li>
                <li>Recent trends in the field of research is not known causing duplication of efforts and resource utilization</li>
            </ul>
