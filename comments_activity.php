...
<body>
  ...
  <h3>Posts on which you've commented so far!</h3>
    <?php
  $link = mysqli_connect("localhost","root","","user_approvals");
  
  $result = mysqli_query($link,"SELECT * FROM `posts` WHERE id in (SELECT pid FROM comments WHERE userid=$userid) ORDER BY id DESC");
