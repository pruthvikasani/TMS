...
<body>
  ...
  <h3>Posts Disliked by you so far!</h3>
    <?php
  $link = mysqli_connect("localhost","root","","user_approvals");
  
  $result = mysqli_query($link,"SELECT * FROM posts WHERE id in (SELECT postid FROM like_unlike WHERE userid =$userid AND type=0) ORDER BY id DESC");
