...
<body>
    ...
    <nav id="nav">
      <ul>
        ...
        <li><a href="titan.php">About TITAN</a></li>
  ...
  <div class="container">
	...
	<div class="col-md-12">
        ...
        <br>         
        <p style="text-align: justify;">As the world and its economies become increasingly globalized, it is necessary to think about open innovation in a global context. The cream of the research work can be tasted in none other than the corridors of education. Recent research and innovation policies put a strong emphasis on interaction between universities and industry. Closer interaction should lead to more relevant research projects, quicker absorption of scientific knowledge in the private sector and better utilization of scientific knowledge. Many forums in the fields of Nanotechnology, Material sciences, Physics, Optics, etc do exist with an objective to connect and share knowledge. Still many industries did not penetrate much as Projects that have been established only with previous contact or strategic need are seen as less positive and with less expectation of continuance. Collaborative research projects formed based on both previous contact and experience need are more positive overall as that can open up new avenues for the growing business. </p> <br>
        <p style="text-align: justify;">Reasonable number of experts, scientists and researchers are available across India. Strengthening interactions between industry and research institutions like universities, colleges and research institutes have over the last years increasingly been seen as a strategic instrument for regional and national innovation, economic growth and competitiveness </p>
