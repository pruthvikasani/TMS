...
-->
    ...
    ?>
  <br>
        <p>*open to public, welcome suggestions</p>
  <!---POST display card -->
      <div class="card bg-light text-dark">
        <div class="card-header">
            <h4>Functional Excellence</h4> <br>
            <p style="text-aling:justify;"><?php echo $functional; ?></p>
        </div>
        <div class="card-body">
            <div class="card-text"><a href="#" style="font-size:30px;text-decoration:none;" id="postlink" data-toggle="modal" data-target="#myModal">write something here....</a></div>
        </div>
      </div>
